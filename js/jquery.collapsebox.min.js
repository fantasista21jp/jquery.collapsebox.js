...
d=s===true?{start:function(){e(this).css("position","absolute")},stop:function(){var c=n();c.position="fixed";e(this).css(c)},containment:"window",refreshPositions:true,handle:b.handle,zIndex:a.zIndex+1,cursor:"move",scroll:false}:i===true?{stop:function(){var c=e(window),f=b.container.offset();if(a.fulcrumX=="right")a.spaceX=c.width()-f.left+c.scrollLeft()-b.container.outerWidth();if(a.fulcrumY=="bottom")a.spaceY=c.height()-f.top+c.scrollTop()-b.container.outerHeight();b.container.get(0).style.setExpression("left",
